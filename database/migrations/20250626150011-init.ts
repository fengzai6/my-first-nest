...
export class Init20250626150011 implements MigrationInterface {
    name = 'Init20250626150011'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "groups" ("id" bigint NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "name" character varying NOT NULL, "description" character varying, "is_organization" boolean NOT NULL DEFAULT false, "parent" bigint, "organization_group" bigint, "leader" bigint, "created_by" bigint NOT NULL, CONSTRAINT "PK_659d1483316afb28afd3a90646e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "group_members" ("id" bigint NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "role" "public"."group_members_role_enum" NOT NULL DEFAULT 'member', "group" bigint, "user" bigint, CONSTRAINT "PK_86446139b2c96bfd0f3b8638852" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "groups" ADD CONSTRAINT "FK_57932d05331a2d1408943a5f791" FOREIGN KEY ("leader") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "groups" DROP CONSTRAINT "FK_57932d05331a2d1408943a5f791"`);
